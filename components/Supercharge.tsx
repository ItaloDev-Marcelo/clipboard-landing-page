...
export const Supercharge = () => {
 ...
 const Companies = [LogoGoogle, LogoIbm,LogoMicrosoft,LogoHp,LogoVector]
  ...
  return (
    <section className='flex flex-col items-center justify-center content-center bg-red-700'>
        <div className="text-center px-3 xl:py-4">
        ...
        <div className="flex flex-col items-center justifty-center content-center gap-20 my-4 ">
        <div className="flex flex-col mt-15 xl:mt-25 gap-5 items-center justify-center xl:flex-row">
            {
        ...
        <div className="flex flex-col items-center xl:scale-125 2xl:scale-120 mt-15 xl:my-20 xl:flex-row gap-y-20 xl:gap-10">
            {
        ...
        <section className="gap-5 text-center my-20 p-5 xl:mt-30 ">
